  ...
  return (
    <>
      <div className="relative w-full hidden md:inline-flex flex-1 h-12 text-base items-center gap-2 justify-between">
        <CiSearch className="text-lg absolute left-2.5 mt-.5 text-lightViolet" />
        <input
          type="text"
        ...
        <button className=" bg-lightViolet text-white px-3.5 py-1.5 mr-1.5 text-sm hover:bg-darkViolet hoverEffect font-medium absolute right-0">
          Search
        </button>
      </div>
    </>
